 ...
 *
 */
public class PBVectorInt implements DBRTimeEvent, PartionedTime {
	ByteArray bar = null;
	short year = 0;
	...
	public PBVectorInt(PVStructure v4Data) {
		...
		PVIntArray pvArray = (PVIntArray) v4Data.getScalarArrayField("value", ScalarType.pvInt);
