 ...
 *
 */
public class PBVectorString implements DBRTimeEvent, PartionedTime {
	ByteArray bar = null;
	short year = 0;
	...
	public PBVectorString(PVStructure v4Data) {
		...
		PVStringArray pvArray = (PVStringArray) v4Data.getScalarArrayField("value", ScalarType.pvString);
